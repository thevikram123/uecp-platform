...
('INC-0431', '2026-07-21T14:35:21+05:30', 'Automated Action Tracker · Human supervised', 'ai', 'INC-0431', 'text', 'en-IN', 'Actions tracked: 50 m hot zone active; two southbound lanes closed; emergency corridor open; lorry cargo verification pending. Sources linked.', NULL, NULL, 1, 7),
...
('INC-0431', '2026-07-21T14:37:40+05:30', 'Automated Voice Relay', 'ai', 'INC-0431', 'audio', 'en-IN', 'Dispatcher-approved voice brief queued to the unreachable zonal ACP. Source audio and field messages remain attached.', NULL, 'relay-en', 1, 12),
